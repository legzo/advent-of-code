...
internal class Day04Test {
    ...
    private val drawNumbers = listOf(7,4,9,5,11,17,23,2,0,14,21,24,10,16,13,6,15,25,12,22,18,20,8,19,3,26,1)

    @Test
    fun `should get first winning score`() {
        findFirstWinningBoard(boards, drawNumbers).score shouldBe 4512
    }

    @Test
    fun `should get last winning score`() {
        findLastWinningBoard(boards, drawNumbers).score shouldBe 1924
    }
